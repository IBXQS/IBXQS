...
Ingredient_const = int (input("Please enter the number of ingredients: "))
...
class PegasusApp:
    ...
    #start of stationanry models
        ...
        self._camera = Camera(
            ...
            position=np.array([2.714, 1.758, 2.951]),
            frequency=30,
            resolution=(640, 640),
        ...
        for i in range(1, Ingredient_const+1):
    ...
    def _update_ingredient_visibility(self):
        for i in range(1, self.ingredient+1):  
            ...
            if cube_obj:
                if i <= Ingredient_const-self.ingredient:
    ...
    def _reset_controllers_and_world(self):
        ...
        self.ingredient = Ingredient_const 
        self.product = 0
        self.inmachine = 0
        self.ontable = 0
